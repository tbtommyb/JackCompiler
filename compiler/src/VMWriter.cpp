...
void VMWriter::writeLabel(const std::string &label) { write("label", label); };

void VMWriter::writeGoto(const std::string &label) { write("goto", label); };

void VMWriter::writeIf(const std::string &label) { write("if-goto", label); };
...
void VMWriter::writeReturn() { write("return"); };
